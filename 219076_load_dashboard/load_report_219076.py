...
def run_dashboard():
    ...
    st.set_page_config(page_title="Delaware County School Load Report", layout="wide")
    st.title("🏫 Delaware County School")
    st.markdown("Load Profile Dashboard - Prepared by Grid Discovery  ")
    st.markdown("---")

    # Load pre-existing CSV data with corrected filename
    file_path = "219076_load_dashboard/219076_delaware_county_primary_school.csv"
